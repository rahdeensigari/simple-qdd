...
If you are going to recoil the motor, use 26 AWG magnet wire with 31 turns-per-slot if you want to get to the same KV I used. Use the following diagram when you are recoiling:
